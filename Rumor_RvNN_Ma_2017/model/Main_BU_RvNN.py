...
from Rumor_RvNN_Ma_2017.model import BU_RvNN
from Rumor_RvNN_Ma_2017.model.BU_RvNN import Node_tweet, gen_nn_inputs
...
for obj in ["Twitter15", "Twitter16"]:  # choose dataset, you can choose either "Twitter15" or "Twitter16"
    ...
    for fold in ['0', '1', '2', '3', '4']:  # fold index, choose from 0-4
        ...
        # lossPath = "Rumor_RvNN_Ma_2017/loss/loss-"+unit+".txt"
        # modelPath = "Rumor_RvNN_Ma_2017/param/param-"+unit+".npz"
