...
import Rumor_RvNN_Ma_2017.torch_model.BU_RvNN
import Rumor_RvNN_Ma_2017.torch_model.BU_Transformer
...
from Rumor_RvNN_Ma_2017.torch_model import BU_Transformer, BU_RvNN
from Rumor_RvNN_Ma_2017.torch_model.BU_RvNN import Node_tweet, gen_nn_inputs
from Rumor_RvNN_Ma_2017.torch_model.evaluate import *
...
def constructTree(tree):
    ...
    x_word, x_index, tree = gen_nn_inputs(root, max_degree=degree, only_leaves_have_vals=False)
